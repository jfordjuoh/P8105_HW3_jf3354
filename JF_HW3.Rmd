...
#PROBLEM: Also how do I make the Question numbers larger and make all the comments smaller?
...
brfss2 <- brfss %>% 
  ...
  summarize(average_dv = (data_value)) %>%
...
brfss3 <- brfss %>% 
  ...
  facet_grid(~year) +
  labs(
    title = "Distribution of Data Value Responses among Locations in New York State, in years 2006 and 2010",
    x = "Data Value",
    y = "Response"
  )
...
#Answer: Based on this graph, this indivivdual's is not active during 12am to 6am which is most likely because they are asleep. Generally, this individual seems to be more active around 8-10pm. 
```
